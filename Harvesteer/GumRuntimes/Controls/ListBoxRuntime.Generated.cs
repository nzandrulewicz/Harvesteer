...
{
    public partial class ListBoxRuntime : Harvesteer.GumRuntimes.ContainerRuntime, Harvesteer.GumRuntimes.IListBoxBehavior
    {
        #region State Enums
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Harvesteer.GumRuntimes.Controls.ListBoxRuntime.VariableState fromState,Harvesteer.GumRuntimes.Controls.ListBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Harvesteer.GumRuntimes.Controls.ListBoxRuntime.ListBoxCategory fromState,Harvesteer.GumRuntimes.Controls.ListBoxRuntime.ListBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        Harvesteer.GumRuntimes.IListBoxBehavior.ListBoxCategory Harvesteer.GumRuntimes.IListBoxBehavior.CurrentListBoxCategoryState
        {
            set
            {
                switch(value)
                {
                    case  Harvesteer.GumRuntimes.IListBoxBehavior.ListBoxCategory.Enabled:
                        this.CurrentListBoxCategoryState = ListBoxCategory.Enabled;
                        break;
                    case  Harvesteer.GumRuntimes.IListBoxBehavior.ListBoxCategory.Disabled:
                        this.CurrentListBoxCategoryState = ListBoxCategory.Disabled;
                        break;
                    case  Harvesteer.GumRuntimes.IListBoxBehavior.ListBoxCategory.Focused:
                        this.CurrentListBoxCategoryState = ListBoxCategory.Focused;
                        break;
                    case  Harvesteer.GumRuntimes.IListBoxBehavior.ListBoxCategory.DisabledFocused:
