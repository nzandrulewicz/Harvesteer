...
{
    public partial class TextBoxRuntime : Harvesteer.GumRuntimes.ContainerRuntime, Harvesteer.GumRuntimes.ITextBoxBehavior
    {
        #region State Enums
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Harvesteer.GumRuntimes.Controls.TextBoxRuntime.VariableState fromState,Harvesteer.GumRuntimes.Controls.TextBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Harvesteer.GumRuntimes.Controls.TextBoxRuntime.TextBoxCategory fromState,Harvesteer.GumRuntimes.Controls.TextBoxRuntime.TextBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Harvesteer.GumRuntimes.Controls.TextBoxRuntime.LineModeCategory fromState,Harvesteer.GumRuntimes.Controls.TextBoxRuntime.LineModeCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
        {
            FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
            if (owner == null)
            {
        ...
        Harvesteer.GumRuntimes.ITextBoxBehavior.TextBoxCategory Harvesteer.GumRuntimes.ITextBoxBehavior.CurrentTextBoxCategoryState
        {
            set
            {
                switch(value)
                {
                    case  Harvesteer.GumRuntimes.ITextBoxBehavior.TextBoxCategory.Enabled:
                        this.CurrentTextBoxCategoryState = TextBoxCategory.Enabled;
                        break;
                    case  Harvesteer.GumRuntimes.ITextBoxBehavior.TextBoxCategory.Disabled:
                        this.CurrentTextBoxCategoryState = TextBoxCategory.Disabled;
                        break;
                    case  Harvesteer.GumRuntimes.ITextBoxBehavior.TextBoxCategory.Highlighted:
                        this.CurrentTextBoxCategoryState = TextBoxCategory.Highlighted;
                        break;
                    case  Harvesteer.GumRuntimes.ITextBoxBehavior.TextBoxCategory.Selected:
                        this.CurrentTextBoxCategoryState = TextBoxCategory.Selected;
                        break;
                }
            }
        }
        Harvesteer.GumRuntimes.ITextBoxBehavior.LineModeCategory Harvesteer.GumRuntimes.ITextBoxBehavior.CurrentLineModeCategoryState
        {
            set
            {
                switch(value)
                {
                    case  Harvesteer.GumRuntimes.ITextBoxBehavior.LineModeCategory.Single:
                        this.CurrentLineModeCategoryState = LineModeCategory.Single;
                        break;
                    case  Harvesteer.GumRuntimes.ITextBoxBehavior.LineModeCategory.Multi:
